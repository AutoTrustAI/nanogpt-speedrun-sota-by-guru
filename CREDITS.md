...
The original MIT license is retained in [LICENSE](LICENSE) and [model/LICENSE](model/LICENSE). Dataset and external dependency licenses remain those of their respective projects.
